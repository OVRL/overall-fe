...
function MomCarouselMobile({
  ...
  return (
    <div
      className="w-full max-w-[100vw] overflow-hidden px-3 py-5 flex flex-col justify-center"
      ref={emblaRef}
      style={{
  ...
  return (
    <div className="fixed inset-0 z-100 flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col justify-center">
        <div className="flex w-full max-w-full flex-col items-center gap-8 md:gap-10 lg:gap-16">
          <div
            className={cn(
