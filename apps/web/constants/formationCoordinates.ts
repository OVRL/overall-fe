...
> = {
  ST: { top: 0.16, left: 0.5026 },
  CF: { top: 0.25, left: 0.5026 },
  LW: { top: 0.16, left: 0.2 },
  RW: { top: 0.16, left: 0.8 },
  RS: { top: 0.16, left: 0.65 },
  LS: { top: 0.16, left: 0.35 },
...
> = {
  ...
  "4-2-3-1": {
    CAM: { top: 0.35, left: 0.5026 },
    LDM: { top: 0.46, left: 0.36 },
    RDM: { top: 0.46, left: 0.63 },
  },
  "4-3-3": {
  ...
  "4-3-2-1": {
    LCM: { top: 0.29, left: 0.33 },
    RCM: { top: 0.29, left: 0.67 },
    LM: { top: 0.35, left: 0.15 },
    RM: { top: 0.35, left: 0.85 },
    CDM: { top: 0.45, left: 0.5 },
  },
  "4-2-2-2": {
  ...
  "3-4-3": {
    LCM: { top: 0.41, left: 0.4 },
    RCM: { top: 0.41, left: 0.6 },
    LM: { top: 0.41, left: 0.2 },
    RM: { top: 0.41, left: 0.8 },
    LW: { top: 0.16, left: 0.2 },
    RW: { top: 0.16, left: 0.8 },
    RCB: { top: 0.6725, left: 0.7 },
    LCB: { top: 0.6725, left: 0.3 },
