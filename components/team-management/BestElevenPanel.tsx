          ...
          {slots.map((slot, index) => {
            ...
            return (
              <button
                ...
                className={`absolute -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center transition-transform hover:scale-105 ${
          ...
          <div className="space-y-1 max-h-[280px] overflow-y-auto">
            {sortedPlayers.map((player) => (
              ...
              >
                ...
                />
                <span className="text-primary text-xs font-bold w-6 text-right">
                  {player.ovr}
                </span>
              </button>
            ))}
