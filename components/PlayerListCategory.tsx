const PlayerListCategory = () => {
  return (
    <thead className="w-full text-[0.6875rem] text-gray-800">
        <tr className="flex justify-between items-center w-full h-6.25 p-1.5 bg-gray-1100 rounded-[1.25rem]">
            ...
            <th scope="col" className="font-normal text-center">선수명</th>
            <th scope="col" className="w-12.25 h-3.25 font-normal">OVR</th>
        </tr>
    </thead>
  )
}
