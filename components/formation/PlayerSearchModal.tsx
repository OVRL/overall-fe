  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Search */}
        <div className="p-4 border-b border-gray-700 bg-surface-card">
          <input
            ref={inputRef}
            type="text"
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 p-2 rounded-lg transition-colors text-left group ${
                      isPlaying
                        ? "bg-surface-card opacity-70 border border-transparent hover:border-gray-500"
                        : "bg-surface-secondary border border-gray-700 hover:bg-surface-card hover:border-primary"
                    }`}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <div
                          className={`font-bold text-sm truncate ${isPlaying ? "text-gray-400" : "text-white"}`}
                        >
                          {player.name}
                        </div>
                        {isPlaying && (
                    ...
                    {/* Quarter Badge */}
                    <div
                      className={`px-2 py-1 rounded text-xs font-bold shadow-sm flex-shrink-0 ${
