...
const quarterButtonVariants = cva(
  "flex items-center justify-center font-bold rounded-full transition-all cursor-pointer disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-surface-tertiary/30 border-3 border-gray-700 text-Label-Primary hover:border-gray-500 hover:bg-surface-tertiary/50 active:scale-95",
        selected:
          "border-3 bg-surface-tertiary/30 border-Fill-AccentPrimary text-Label-AccentPrimary hover:brightness-110 active:scale-105",
        add: "bg-surface-tertiary/30 border border-dashed border-border-card text-Fill_Primary hover:border-gray-400 hover:text-white hover:bg-surface-tertiary/50 active:scale-95",
        assistive:
