...
const AdBanner = () => {
    return (
        <div className="relative w-[124px] h-[38px] bg-black rounded-lg overflow-hidden border border-gray-800 flex items-center justify-between px-2 shrink-0">

            {/* Left: G Logo */}
            <div className="flex flex-col items-center">
                <span className="text-white font-black text-lg italic leading-none">G</span>
            </div>

            {/* Center: Text */}
            <div className="flex flex-col items-start ml-1">
                <span className="text-[6px] text-gray-300 leading-tight">THE SPORTS DRINK</span>
                <span className="text-[5px] text-orange-500 font-bold tracking-wider">GAME CHANGER</span>
            </div>
